---
name: cstk-commit
description: "Commit staged and unstaged changes with a well-crafted conventional commit message. Handles submodule updates, multi-service changes, and follows project conventions. Triggers: \"/commit\", \"commit\", \"commitar\", \"fazer commit\", \"commit changes\"."
---

# CSTK Adaptation

Adapted from `JotJunior/cstk` skill `commit` at commit `35922cf`.
...
- Always end with `Co-Authored-By: Codex Opus 4.6 <noreply@anthropic.com>`
