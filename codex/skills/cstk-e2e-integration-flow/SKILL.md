---
name: cstk-e2e-integration-flow
...
Adapted from `JotJunior/cstk` skill `e2e-integration-flow` at commit `35922cf`.
...
`the user's request` is the feature/flow to test (e.g. "cadastro de cliente", "checkout
