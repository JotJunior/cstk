---
name: cstk-go-add-test
description: "Add unit or integration tests to Go microservices using established project patterns. Use when Codex needs to write Go tests, mocks, fixtures, or coverage for service, domain, handler, repository, or consumer layers."
---

# CSTK Adaptation

Adapted from `JotJunior/cstk` skill `go-add-test` at commit `35922cf`.
