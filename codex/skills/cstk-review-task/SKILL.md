...
Adapted from `JotJunior/cstk` skill `review-task` at commit `35922cf`.
...
`feature-00c` em `<projeto>/.codex/feature-00c-state/<feature>/`,
...
```bash
STATE_DIR="<projeto>/.codex/feature-00c-state/<feature>"
~/.codex/skills/cstk-agente-00c-runtime/scripts/model-routing-report.sh \
...
```bash
~/.codex/skills/cstk-agente-00c-runtime/scripts/state-decisions-reconcile.sh \
...
`<projeto>/.codex/feature-00c-state/<feature>/`, garanta que TODA task
...
~/.codex/skills/cstk-agente-00c-runtime/scripts/state-ondas.sh \
