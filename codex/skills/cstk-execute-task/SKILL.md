...
Adapted from `JotJunior/cstk` skill `execute-task` at commit `35922cf`.
...
Encontre a tarefa especifica: **the user's request**
...
**EXECUTE AGORA A TAREFA: the user's request**
