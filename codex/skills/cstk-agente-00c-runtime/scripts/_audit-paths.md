...
```sh
_proj_ignore="$_proj_dir/.codex/agente-00c-state/secrets-filter-ignore"
```
...
- (a) **SHARED**: ambos orquestradores leem do mesmo arquivo
  `.codex/agente-00c-state/secrets-filter-ignore` — config no nivel
  do projeto, nao do orquestrador. Reduz duplicacao + ambos operam ao
  mesmo nivel de confianca.
- (b) **SPLIT**: feature-00c le de
  `.codex/feature-00c-state/<short>/secrets-filter-ignore` — config
...
```sh
# Linha 175
$_ISH_PAP/.codex/agente-00c-report.md
# Linha 177
$_ISH_PAP/.codex/agente-00c-suggestions.md#$_sug
# Linha 179
$_ISH_PAP/.codex/agente-00c-state/state-history/$_ISH_ONDA-<timestamp>.json
```
...
```sh
"- Estado: ${PAP}/.codex/agente-00c-state/state.json"
"- Backups de estado: ${PAP}/.codex/agente-00c-state/state-history/"
"- Sugestoes detalhadas: ${PAP}/.codex/agente-00c-suggestions.md"
"- Whitelist: ${PAP}/.codex/agente-00c-whitelist"
```
...
- report: `<projeto>/.codex/feature-00c-state/<short>/feature-00c-report.md`
- suggestions: `<projeto>/.codex/feature-00c-suggestions.md` (compartilhada per-projeto)
- state-history: `<projeto>/.codex/feature-00c-state/<short>/backups/`
