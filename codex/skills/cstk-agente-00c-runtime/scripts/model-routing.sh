...
#      ao script (DEV) > path canonico ~/.codex/skills/...
...
#   4. ~/.codex/skills/cstk-model-selector/scripts/classify.sh (instalacao).
...
_mr_resolve_skill_path() {
  ...
  _mr_candidate_install="${HOME}/.codex/skills/cstk-model-selector/scripts/classify.sh"
