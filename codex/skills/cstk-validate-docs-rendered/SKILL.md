---
name: cstk-validate-docs-rendered
...
Adapted from `JotJunior/cstk` skill `validate-docs-rendered` at commit `35922cf`.
...
Determinar o escopo a partir de `the user's request`:
