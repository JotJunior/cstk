---
name: cstk-validate-documentation
...
Adapted from `JotJunior/cstk` skill `validate-documentation` at commit `35922cf`.
...
Codex deve invocar esta skill automaticamente quando:
