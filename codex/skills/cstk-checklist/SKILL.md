...
Adapted from `JotJunior/cstk` skill `checklist` at commit `35922cf`.
...
Derivar dominio do checklist a partir de the user's request:
...
Gerar ate 3 perguntas contextuais baseadas em sinais do projeto e the user's request.
