...
- [ ] 1.1.1 Adicionar `FR-010` a `spec.md` declarando, em linguagem MUST, o
...
- [ ] 1.1.2 Adicionar `SC-005` a `spec.md` com criterio mensuravel para o
...
- [ ] 1.1.3 Registrar sugestao via `suggestions.sh register` (severidade
...
- [ ] 1.2.1 Adicionar Cenario 10 a `quickstart.md` usando os valores reais
...
- [ ] 1.2.3 Atualizar `data-model.md` §Regra transversal NULL vs zero citando
...
- [ ] 1.3.1 Adicionar `FR-011` a `spec.md` declarando, em linguagem MUST, que
...
- [ ] 1.4.1 Adicionar uma nota em `spec.md` (secao Edge Cases ou nova
...
- [ ] 1.4.2 Referenciar `sug-002` (knowledge.db) como o item que trata esse
      bugfix separadamente, sem expandir o escopo desta feature
- [ ] 1.4.3 Confirmar via `grep -rn "session_id" docs/specs/otel-model-breakdown/*.md`
