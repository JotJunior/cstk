...
- **[decision]** claude-ai-tips/cstk-knowledge-db/onda-006 (2026-05-23T...): FASE 7 (hook fim-de-onda): onde disparar cstk recall --ingest...
- **[skill]** claude-ai-tips/cstk-knowledge-db/onda-004 (2026-05-23T...): geracao de checklist de qualidade de REQUISITOS...
```
