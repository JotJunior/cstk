...
# da skill briefing (plugins/cstk/skills/briefing/templates/briefing.md):
...
# skill create-tasks (plugins/cstk/skills/create-tasks/templates/tasks.md):
...
_pl_validate_tasks() {
  ...
  if [ -n "$_missing" ]; then
    ...
    printf '  Template: plugins/cstk/skills/create-tasks/templates/tasks.md\n' >&2
    return 1
  fi
  return 0
}
